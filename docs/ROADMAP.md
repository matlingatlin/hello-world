...
Goal: build out the agent and the chosen flagship loop for real, with guardrails and
tests.
...
Goal: tenant isolation, sandbox hardening, rate limits, usage/cost metering, billing
stub.
