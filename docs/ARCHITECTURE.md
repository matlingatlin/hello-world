...
- AI engine & agent — context pipeline, agent loop, model routing, guardrails.  (Phase 2)
- Code execution & preview — sandbox, dev server, preview streaming.  (Phase 2)

## Platform layer
- Backend / API — orchestration, job queue, streaming, project & user management.  (Phase 2)
- Data — database, object storage, secrets.  (Phase 2)
- Integrations — DB provisioning, GitHub export, deploy targets, MCP connectors.  (Phase 2)
